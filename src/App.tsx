...
const App = () => {
  ...
  return (
    <div>
      ...
      />
      <button onClick={handleInsert} style={{ position: 'absolute', top: 20, left: 180, backgroundColor: 'white', color: 'black', borderRadius: 0}}>
        Insert
      </button>
      <button onClick={handleDelete} style={{ position: 'absolute', top: 20, left: 255, backgroundColor: 'white', color: 'black', borderRadius: 0}}>
  Delete
</button>
<button onClick={searchHandle} style={{ position: 'absolute', top: 20, left: 335, backgroundColor: 'white', color: 'black', borderRadius: 0}}>
  Search
</button>
<footer>
<p style={{ position: 'absolute', bottom: 0, left: 20, backgroundColor: 'white', color: 'black', borderRadius: 0}}>Crafted by Sidali DJEGHBAL - Built using Three.js and TWEEN.JS.</p>
</footer>
      <div ref={mountRef} />
    </div>
